  ...
  <div class="auth-page">
    <div class="auth-brand">
      <div class="brand-content">
        <div class="brand-logo" v-html="logoSvg" />
    ...
    <div class="auth-main">
      <div class="auth-card">
        <div class="card-header">
          <div class="card-logo" v-html="logoSvg" />
          <h2 class="card-title">Create your account</h2>
          <p class="card-subtitle">Start organising your tasks in minutes.</p>
        </div>

        <form class="auth-form" @submit.prevent="handleRegister">
          <div class="field-group">
            <label class="field-label" for="username">Username</label>
            <input id="username" v-model="form.username" class="auth-input" type="text" placeholder="Your username"
              autocomplete="username" @keyup.enter="handleRegister" />
          </div>

          <div class="field-group">
            <label class="field-label" for="email">Email</label>
            <input id="email" v-model="form.email" class="auth-input" type="email" placeholder="name@example.com"
              autocomplete="email" @keyup.enter="handleRegister" />
          </div>
          ...
          <div class="field-group">
            ...
            <div class="pw-field">
              <input id="password" v-model="form.password" class="auth-input" :type="showPassword ? 'text' : 'password'"
                placeholder="Min. 8 characters" autocomplete="new-password" @keyup.enter="handleRegister" />
